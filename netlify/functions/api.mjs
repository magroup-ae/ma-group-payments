...
<style>
  *{box-sizing:border-box} body{font-family:"Segoe UI",Arial,sans-serif;color:#1f2733;margin:0;background:#fff;font-size:12.7px;line-height:1.55}
  ...
  .ft{margin-top:20px;border-top:1px solid #e3e7ee;padding-top:8px;color:#7a8494;font-size:10.5px;text-align:center}
</style></head><body><div class="page">
  <div class="lh"><img src="${logo}" alt="" onerror="this.style.display='none'"><div><div class="n1">${esc(ent)}</div><div class="n2">Marvellous Art · MA Building Contracting · MA Building Maintenance${entTrn ? " — TRN " + esc(entTrn) : ""} · +971 80062244 · info@maagroup.ae</div></div></div>
  ...
  <div class="sig">Best regards,<br><b>Procurement Department</b><br>${esc(ent)}<br>${entTrn ? "TRN " + esc(entTrn) + " · " : ""}+971 80062244 · info@maagroup.ae</div>
  <div class="ft">This Request for Quotation is confidential and intended only for the addressed vendor. ${esc(rec.rfqNo)} · Generated by the MA Group Procurement System.</div>
</div></body></html>`;
}
